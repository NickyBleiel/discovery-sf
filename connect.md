...
1.  Read the [General Source Requirements](/docs/services/discovery-sf/connect.html#gen_req) to get a general understanding of what will be required.
...
3.  Read the source configuration instructions based on your configuration choice:
    -  [Using the tooling](/docs/services/discovery-sf/connect.html#source_tooling)
    -  [Using the API](/docs/services/discovery-sf/connect.html#source_api)
...
See [Information security ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://console.bluemix.net/docs/services/discovery/information-security.html){: new_window} for more information about deleting based on `customer_id`.